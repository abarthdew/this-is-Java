...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11.png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(1).png)

- Wrapper 클래스 예) int 값을 Integer로, 객체화해서 만들 수 있음

## **11.3 Object 클래스(1)**

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(2).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(3).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(4).png)

- equals() 메서드 재정의

### hashCode()

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(5).png)

- 두 객체 비교 과정: 두 객체의 hashCode 검증(hashCode) → 두 객체의 내부 데이터 검증(equals) → 리턴

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(6).png)

- hashMap의 데이터 저장 구조

### toString()

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(7).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(8).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(9).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(10).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(11).png)

- 연산이 되는 정적 유틸리티 메서드를 제공하는 클래스라고 설명되어 있음
- 대부분의 메서드들이 static으로 선언 → 객체를 만들지 않고도 메서드를 사용할 수 있음

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(12).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(13).png)

- compare() 메서드 사용 시, 반드시 Comparator 인터페이스를 구현한 구현 객체를 만들어야 함

### Objects.equals(), Objects.deepEquals()

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(14).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(15).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(16).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(17).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(18).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(19).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(20).png)

- 보통 프로그램 실행 시간을 측정할 때 사용함

### System.getProperty()

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(21).png)

- 키-값 형태기 때문에 key를 매개변수로 결과값을 얻음

### System.getenv()

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(22).png)

## **11.6 Class 클래스**

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(23).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(24).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(25).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(26).png)

- Defelicated: 업데이트 전 버전이니 사용하지 말 것

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(27).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(28).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(29).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(30).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(31).png)

- charAt(n): String 배열에서 n 번째 배열의 문자만 뽑아내고 싶을 때 
    (ex) 주민번호 추출 등   

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(32).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(33).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(34).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(35).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(36).png)

- valueOf: 정적 메서드(기본 타입 값을 문자열로 만들어줌)

## **11.8 StringTokenizer 클래스**

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(37).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(38).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(39).png)

- 정규 표현식: 사용자가 입력한 데이터가 올바른 형식대로 입력되었는지 검증하는 데 사용

## **11.11 Arrays 클래스(1)**

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(40).png)

- 배열 조작 기능을 가진 util 클래스

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(41).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(42).png)

- Arrays.equals()는 A1, A2 배열의 a, b, c의 값(번지)을 각각 비교함

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(43).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(44).png)
...
- 중첩 배열 항목 값 비교
    ...
    ![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(45).png)
    
    ⇒ original, clone1이 가리키는 항목(1,2,3,4)가 서로 같으므로 true

[깊은 복사 후 비교]

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(46).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(47).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(48).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(49).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(50).png)
...
- 포장 객체는 객체이므로 ==, ≠가 아닌 equals() 메서드로 내부 값 비교
    ...
    ![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(51).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(52).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(53).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(54).png)

- 종자값이 달라지만 다른 난수를 얻음

## **11.14 Date,Calendar 클래스**

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(55).png)

- 날짜, 시간을 얻어내는 클래스
- Date: 날짜를 얻는다기 보다, 현재 시간의 날짜를 표현하는 클래스. 현재 시간의 스냅샷, 현  시점의 바로 그 값을 가지고 있는 객체를 만들 때 사용. **즉, 객체는 생성되는 순간의 시스템의 날짜를 가지고 있게 됨.**

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(56).png)

- Calender는 생성자를 이용해 객체를 만들지 않고, getInstance()를 이용해 현재 시스템의 날짜로 만든 달력 객체를 리턴해 줌

## **11.15 Format 클래스**

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(57).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(58).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(59).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(60).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(61).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(62).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(63).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(64).png)

## **11.16 java.time 패키지(3)**

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(65).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(66).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(67).png)

- java.time 패키지 내 자바 문서 TemporalAdjusters

## **11.16 java.time 패키지(4)**

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(68).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(69).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(70).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(71).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(72).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(73).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(74).png)

- 자바 문서의 DateTimeFormatter 하단에서 다양한 날짜 및 시간 포맷 형식을 접할 수 있음

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/11(75).png)
