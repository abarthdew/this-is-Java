...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7.png)

- 현실: 부모가 자식 선택, 상속해 줌
- 객체 지향 프로그램: 자식이 부모 선택, 상속 받음

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(1).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(2).png)

- 패키지가 다를 경우, package2에 있는 자식 클래스는 package2에 있는 부모 클래스가 가진 `default` 필드와 메서드를 상속 받지 못함

## **7.2 클래스 상속**

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(3).png)

## **7.3 부모 생성자 호출**

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(4).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(5).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(6).png)

- 메서드 재정의 = 오버라이드
- @Override: 코드가 제대로 작성했는지 검사하는 어노테이션

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(7).png)

- 재정의된 method2()는 부모 클래스가 아닌 자식 클래스의 메서드를 가리킴
- override 단축기: ctrl + space

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(8).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(9).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(10).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(11).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(12).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(13).png)

- 자동 타입 변환: 부모 타입에 여러 자식 객체를 대입할 수 있음

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(14).png)

- cat == animal은 같은 번지를 참조하므로 true지만, 타입은 각각 Cat, Animal로 다름

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(15).png)

- A에는 B, C, D, E 모두 대입 가능
- B에는 D 대입 가능
- C에는 E 대입 가능

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(16).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(17).png)

- 필드, 매개변수를 통해서 등 다형성이 발생할 수 있음

## **7.7 타입변환과 다형성(3)**

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(18).png)

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(19).png)

- void drive(Vehicle vehicle) 과 같이 매개 변수는 Vehicle 타입이지만, 이 객체의 자식인 Bus 타입 객체가 매개 변수로 올 수도 있음

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(20).png)

- 부모타입 → 자식타입 변환은 자동이 아니므로, 강제함
- 부모 객체 A, 자식 객체 B가 있을 경우
    
    ![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(21).png)
...
- 부모 객체 A, 자식 객체 B, C가 있을 경우
    ...
    ![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(22).png)
...
![강제 타입 변환이 필요한 경우](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(23).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(24).png)
...
![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(25).png)

- 추상 클래스: 실체 객체들 간 공통되는 특성을 추출한 클래스
- 단독으로 new 키워드를 사용해 객체 생성불가, 부모 클래스로만 사용

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(26).png)

- 각기 다른 개발자 A, B, C가 각각 클래스를 만들 때, 비슷한 기능을 이름만 다르게 여러 개 만들면 가독성에 좋지 않으므로, 이름을 통일할 목적

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(27).png)

- 예) 자동차를 만들 때, 타이어는 규격을 정해놓고, 규격에 맞는 타이어만 끼울 수 있도록 함

![Untitled](https://github.com/abarthdew/this-is-java/blob/main/00.basics/images/7(28).png)
