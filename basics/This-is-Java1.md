...
![Untitled](./images/1(14).png)

## 1.6 이클립스 설치

![Untitled](./images/1(15).png)

![Untitled](./images/1(16).png)

- Java EE: 자바 웹 애플리케이션, 웹 서비스를 사용할 수 있음

![Untitled](./images/1(17).png)

- 기본적으로 이렇게 뷰가 배치된 것을 Perspective 라고 함. 기본값은 Java EE. Web 서비스를 개발할 때 사용.

![Untitled](./images/1(18).png)

![Untitled](./images/1(19).png)

- 본 수업은 웹 서비스 개발이 아니므로 Java Perspective 사용.

![Untitled](./images/1(20).png)

- .metadata: 폰트, 설정 등

![Untitled](./images/1(21).png)

- window - show view : 뷰 조작

### 자바 프로젝트 생성

![Untitled](./images/1(22).png)

![Untitled](./images/1(23).png)
